...
use std::io;
use rand::prelude::*; // Provides Rng, Distribution, thread_rng, etc.
// use rand::distributions::{Distribution, Uniform}; // Corrected path, should work with "rand = "0.8""
use rand::distributions::{Uniform}; // Removed unused Distribution
